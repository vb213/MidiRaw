...
public:
                                     ...
                                     const Slider::SliderStyle style, Slider& slider) override
    {
        ...
        if (slider.isHorizontal())
        {
            ...
            if (isTwoValue)
            {
                clbar.addRoundedRectangle(Rectangle<float>(juce::Point<float>(minSliderPos, iy), juce::Point<float>(maxSliderPos, iy+sliderRadius)),sliderRadius/2.0,sliderRadius/2.0);
            }
            else
            {
                clbar.addRoundedRectangle(Rectangle<float>(juce::Point<float>(x+width*zeroPos, iy), juce::Point<float>(sliderPos, iy+sliderRadius)),sliderRadius/2.0,sliderRadius/2.0);
            }
        }
        else
        {
            ...
            slbg.addRoundedRectangle (r,sliderRadius/2.0,sliderRadius/2.0);
            clbar.addRoundedRectangle(Rectangle<float>(juce::Point<float>(ix+1.0f,y+ height * (1.0f-zeroPos)), juce::Point<float>(ix-1.0f+sliderRadius,sliderPos)),sliderRadius/2.0,sliderRadius/2.0);
        }
