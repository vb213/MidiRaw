...
std::vector<std::unique_ptr<juce::RangedAudioParameter>> CqtanalyzerAudioProcessor::createParameterLayout()
{
    ...
    params.push_back (OSCParameterInterface::createParameterTheOldWay ("midiChannel", "MIDI Channel ", "",
                                                                       juce::NormalisableRange<float> (1.0f, 16.0f, 1.0f), 1.0f,
                                                                       [](float value) {return juce::String (static_cast<int> (value));}, nullptr));
